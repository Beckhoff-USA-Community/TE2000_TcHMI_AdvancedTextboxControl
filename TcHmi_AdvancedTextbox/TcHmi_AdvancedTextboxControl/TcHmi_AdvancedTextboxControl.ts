...
module TcHmi {
    export module Controls {
        export module Training {
            export class AdvancedTextbox extends TcHmi.Controls.Beckhoff.TcHmiTextbox {
                ...
                */
                ...
                // Template.html element references
                public __elementTemplateRoot: JQuery<HTMLElement>;
                public __elementTextarea: JQuery<HTMLElement>
                public __elementTooltipText: JQuery<HTMLElement>


                public __isPopUp: boolean;

                public __CheckColors: CheckColors;
                public __InputSettingsAllow: InputSettingsAllow;
                public __InputSettingsCheck: InputSettingsCheck;

                public __ValidValue: boolean;


                public __PopUpKeyboardSettings: PopUpKeyboardSettings;
                public __PopUpKeyboardControl: TcHmi.Controls.Beckhoff.TcHmiKeyboard | undefined = undefined;

                
                public __initValue: string;

                public __PopUpTextBox: TcHmi.Controls.Beckhoff.TcHmiTextbox | undefined;
                public __PopUpTextBoxPadding = 3;

                public __keyboardRelationalPlacement = true;

                /** Declare internal settings variables for keyboard, tooltip etc. */
                public __HighlightTimeoutId: number;
                public __TooltipTimeoutId: number;
                public __PageLayout = { Width: 0, Height: 0 };
                public __TextboxLayout = { Width: 0, Height: 0, Left: 0, Top: 0 };
                public __KeyboardLayout: KeyboardLayout = {
                    Width: 0,
                    Height: 0,
                    Left: 0,
                    Top: 0,
                    KeyboardPadding: {} as FourSidedCss,
                    KeyPadding: {} as FourSidedCss,
                    AdditionalKeyBackdropPadding: {} as FourSidedCss,
                    FromTheBottom : false
                };
                public __TooltipLayout = { Position: 'top' };
                ...
                public __evtNsKeyDown = 'keydown.' + this.guid;

                /** Declare an array to store all destroy functions of registered tchmi framework events */
                public __PopupEventDestroyFunctions: Array<DestroyFunction> = [];
                public __EventDestroyFunctions: Array<DestroyFunction> = [];
                ...
                */
                ...
                public __setTchmiEvents = function (tcHmiControl: AdvancedTextbox) {
                ...
                public __destroyTchmiEvents = function (tcHmiControl: AdvancedTextbox) {
                ...
                * @returns null
                */
                public __onEnterPress(_this: AdvancedTextbox) {
                ...
                /**
                  ...
                  */
                public __onTextareaKeyDown() {
                    logToConsole("__onTextareaKeyDown");

                    var _this = this;
                    return function (eventData?: any) {
                        var textObject;
                ...
                public getClassNameOfRelatedTarget(eventData?: any) {
                ...
                public __onTextChanged(eventData?: any) {
                 ...
                 */
                public _onUserInteractionFinished(eventData?: any) {
                 ...
                 */
                public _onUserInteractionCanceled(eventData?: any) {
                 ...
                 */
                public _onFocusIn(eventData?: any) {
                ...
                public _onFocusOut(eventData?: any) {
      ...
      */
                 ...
                 * @returns Boolean
                 */
                public SetInitValueOnTempTextbox() {
                    this.__PopUpTextBox!.setText(this.getText() as string);
                }
                ...
                public SetSavedValue() {
                    this.__initValue = this.getText() as string;
                ...
                public OpenPopUpKeyboard() {
                    ...
                    if (TcHmi.Controls.get('AdvancedTextbox_PopUpKeyboard') === undefined) {
                        ...
                        this.__PopUpKeyboardControl = TcHmi.Controls.get('AdvancedTextbox_PopUpKeyboard') as Beckhoff.TcHmiKeyboard;
                    ...
                    if (this.__PopUpKeyboardControl !== undefined) {
                        ...
                        if (this.__PopUpKeyboardSettings.ZIndex) {
                            ...
                            this.__PopUpKeyboardControl.setZindex(this.getZindex() as number);
                        }
                        ...
                        if (this.IsKeypad()) {
                            ...
                            if (this.__PopUpKeyboardSettings.Textbox) {
                                this.__PopUpKeyboardControl.setLeft(this.__KeyboardLayout.Left);
                ...
                public OpenTempTextBox() {
                    ...
                    if (this.__PopUpKeyboardSettings.Textbox) {
                        if (TcHmi.Controls.get('AdvancedTextbox_Text') === undefined) {
                            ...
                            this.__PopUpTextBox = TcHmi.Controls.get('AdvancedTextbox_Text') as Beckhoff.TcHmiTextbox;
                        ...
                        if (this.__PopUpTextBox !== undefined) {
                            ...
                            if (this.__PopUpKeyboardSettings.ZIndex) {
                                ...
                                this.__PopUpTextBox.setZindex(this.getZindex() as number);
                            }
                            ...
                            tempTextBoxDomObject.ready(function () {
                                logToConsole("Setting Focus to: " + _this.__PopUpTextBox?.getId())
                 ...
                 * @returns {void}
                 */
                public OpenTooltip(TooltipText: string, Timeout?: number) {
                 ...
                 */
                public CheckValue(Timeout?: number) {
                ...
                public CopyDataToPrimaryTextBox() {
                    ...
                    if (this.__PopUpKeyboardSettings.Textbox && this.__PopUpTextBox !== undefined && this.CheckValue(0)) {
                        ...
                        this.setText(this.__PopUpTextBox.getText() as string);
                    }
                }
                 ...
                 */
                public __CheckPermissions(permissionName: string, _this: Beckhoff.TcHmiTextbox) {
                 ...
                 * @returns {void}
                 */
                public __CalculateKeyboardPosition() {
                    // Get the current page layout
                    this.__PageLayout.Width = TcHmi.View.get()!.getRenderedWidth() as number;
                    this.__PageLayout.Height = TcHmi.View.get()!.getRenderedHeight() as number;
                    
                    //// Get the current textbox layout
                    //this.__TextboxLayout.Width = this.getRenderedWidth() as number;
                    //this.__TextboxLayout.Height = this.getRenderedHeight() as number;
                    //this.__TextboxLayout.Left = this.getRenderedLeft() as number;
                    //this.__TextboxLayout.Top = this.getRenderedTop() as number;

                   

                    let _tempBounds: DOMRect = this.__element[0].getBoundingClientRect();

                    this.__TextboxLayout.Width = _tempBounds.width;
                    this.__TextboxLayout.Height = _tempBounds.height;
                    this.__TextboxLayout.Left = _tempBounds.left;
                    this.__TextboxLayout.Top = _tempBounds.top;
                 ...
                 * @returns {void}
                 */
                public __CalculateTooltipPosition() {
                    // Get the current textbox layout
                    this.__TextboxLayout.Top = this.getRenderedTop() as number;
                 ...
                 * @returns {void}
                 */
                public __SetCheckHighlighting(Result: boolean, Timeout?: number) {
                    // Check if a valid color is available
                    if (this.__CheckColors === undefined || this.__CheckColors === null) return;
                 ...
                 * @returns {void}
                 */
                public __ClearCheckHighlighting() {
                 ...
                 * @returns {void}
                 */
                public setCheckColors(NewColors: CheckColors) {
                    ...
                    this.__CheckColors = convertedSettings as CheckColors;
                 ...
                 * @returns {void}
                 */
                public setInputSettingsAllow(NewSettings: InputSettingsAllow) {
                    ...
                    // Remember the new settings
                    this.__InputSettingsAllow = convertedSettings as InputSettingsAllow;
                 ...
                 * @returns {void}
                 */
                public setInputSettingsCheck(NewSettings: InputSettingsCheck) {
                    var convertedSettings: InputSettingsCheck = TcHmi.ValueConverter.toObject(NewSettings) as InputSettingsCheck;
                    if (convertedSettings === null) {
                        // If we have no value to set we have to fall back to the defaultValueInternal from JSON
                        convertedSettings = this.getAttributeDefaultValueInternal('InputSettingsCheck') as InputSettingsCheck;
                    }
                 ...
                 * @returns {void}
                 */
                public setPopUpKeyboardSettings(NewSettings: PopUpKeyboardSettings) {
                    var convertedSettings: PopUpKeyboardSettings = TcHmi.ValueConverter.toObject(NewSettings) as PopUpKeyboardSettings;
                    if (convertedSettings === null) {
                        // If we have no value to set we have to fall back to the defaultValueInternal from JSON
                        convertedSettings = this.getAttributeDefaultValueInternal('PopUpKeyboardSettings') as PopUpKeyboardSettings;
                    }
                 ...
                 */
                public getPopUpKeyboardSettings() {
        ...
        export namespace Training {
            ...
            export interface PopUpKeyboardSettings {
                Active: boolean;
                Type: string; // layout file
                Textbox: boolean;
            ...
            export interface InputSettingsAllow {
                Numbers: boolean;
                Strings: boolean;
            }

            export interface InputSettingsCheck {
        ...
        registerEx('AdvancedTextbox', 'TcHmi.Controls.Training', Training.AdvancedTextbox);

    }
        
    // Debugging function for logging
        function logToConsole(logThis : any): void {
