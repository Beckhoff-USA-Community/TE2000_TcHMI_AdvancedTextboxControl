    ...
    module Controls {
        module Beckhoff {
            class TcHmiRecipeSelect extends TcHmi.Controls.System.TcHmiControl {
                ...
                protected __documentMouseMoveListener: ((event: MouseEvent) => void) | null | undefined;
                ...
                protected __documentMouseUpListener: ((event: MouseEvent) => void) | null | undefined;
                ...
                */
                protected __onServerDomainWatchCallback(): (data: Symbol.IWatchResultObject<Server.Domains.IDomainInfo>) => void;
                /**
                * Process access
                */
                ...
                * @param {string} valueNew
                */
                setServerInterval(valueNew: string): void;
                /**
